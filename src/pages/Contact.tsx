    ...
    <Layout>
      <section className="bg-gradient-to-br from-portfolio-800 via-portfolio-700 to-portfolio-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4 animate-fade-in">Contact Me</h1>
              ...
              <div className="space-y-6 mt-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">jay.patel@email.com</p>
                  </div>
                </div>
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a 
                    ...
                    className="bg-portfolio-100 p-3 rounded-lg text-portfolio-600 hover:bg-portfolio-200 transition-colors"
                    aria-label="LinkedIn"
                  >
            ...
            <div className="md:col-span-2">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Fill out the form below to send me a message. I'll respond as soon as possible.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button 
                      type="submit" 
                      className="w-full bg-portfolio-600 hover:bg-portfolio-700"
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <SectionHeader 
            ...
            subtitle="Thank you for taking the time to visit my portfolio. I'm excited about the possibility of working together!"
          />
        </div>
      </section>
    </Layout>
